...
type ChatMessage struct {
	...
	From          string                 `protobuf:"bytes,1,opt,name=from,proto3" json:"from,omitempty"`       // Tên người gửi
	To            string                 `protobuf:"bytes,2,opt,name=to,proto3" json:"to,omitempty"`           // Tên người nhận
	Message       string                 `protobuf:"bytes,3,opt,name=message,proto3" json:"message,omitempty"` // Nội dung
...
const file_chat_chat_proto_rawDesc = "" +
	"\n" +
	"\x0fchat/chat.proto\x12\x04chat\"K\n" +
	"\vChatMessage\x12\x12\n" +
	"\x04from\x18\x01 \x01(\tR\x04from\x12\x0e\n" +
	"\x02to\x18\x02 \x01(\tR\x02to\x12\x18\n" +
	"\amessage\x18\x03 \x01(\tR\amessage2?\n" +
	"\vChatService\x120\n" +
	"\x04Chat\x12\x11.chat.ChatMessage\x1a\x11.chat.ChatMessage(\x010\x01B/Z-example.com/grpcbidichatUPGRADE/pkg/chat;chatb\x06proto3"
