...
func getEvent(context *gin.Context) {
	...
	if err != nil {
		context.JSON(http.StatusBadRequest, gin.H{"message": "Could not parst event id."})
		return
	}
...
func updateEvent(context *gin.Context) {
	...
	if err != nil {
		context.JSON(http.StatusInternalServerError, gin.H{"message": "Could not uopdate event."})
		return
	}
